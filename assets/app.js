...
function renderArticle() {
  ...
  structured.textContent = JSON.stringify({"@context":"https://schema.org","@type":"BlogPosting",headline:post.title,description:post.summary,datePublished:post.date,...(post.cover ? {image:new URL(post.cover, location.href).href} : {}),author:{"@type":"Person",name:"知微"},inLanguage:"zh-CN"}); document.head.append(structured);
