...
for (const [file, pathname] of [["index.html", ""], ["about.html", "about.html"], ["moments.html", "moments.html"]]) {
...
const urls = ["", "about.html", "moments.html", ...generated.map(post => post.url || `posts/${encodeURIComponent(post.slug)}.html`)];
